...
enum GamePlatform {
  ...
  String get displayName {
    switch (this) {
      case GamePlatform.wii: return 'Nintendo Wii';
      case GamePlatform.gamecube: return 'Nintendo GameCube';
      case GamePlatform.wiiU: return 'Nintendo Wii U';
      case GamePlatform.nes: return 'NES';
      case GamePlatform.snes: return 'SNES';
      case GamePlatform.n64: return 'Nintendo 64';
      case GamePlatform.gameboy: return 'Game Boy';
      case GamePlatform.gbc: return 'Game Boy Color';
      case GamePlatform.gba: return 'Game Boy Advance';
      case GamePlatform.nds: return 'Nintendo DS';
      case GamePlatform.threeDS: return 'Nintendo 3DS';
      case GamePlatform.psp: return 'PSP';
      case GamePlatform.ps1: return 'PlayStation';
      case GamePlatform.ps2: return 'PlayStation 2';
      case GamePlatform.genesis: return 'Sega Genesis';
  ...
  String get folderPath {
    switch (this) {
      case GamePlatform.wii: return 'wbfs';
      case GamePlatform.gamecube: return 'games';
      case GamePlatform.wiiU: return 'wiiu/games';
      case GamePlatform.nes: return 'roms/NES';
      case GamePlatform.snes: return 'roms/SNES';
      case GamePlatform.n64: return 'roms/N64';
      case GamePlatform.gameboy: return 'roms/GB';
      case GamePlatform.gbc: return 'roms/GBC';
      case GamePlatform.gba: return 'roms/GBA';
      case GamePlatform.nds: return 'roms/NDS';
      case GamePlatform.threeDS: return 'roms/3DS';
      case GamePlatform.psp: return 'roms/PSP';
      case GamePlatform.ps1: return 'roms/PS1';
      case GamePlatform.ps2: return 'roms/PS2';
      case GamePlatform.genesis: return 'roms/Genesis';
      case GamePlatform.dreamcast: return 'roms/Dreamcast';
      default: return 'roms/Unknown';
    }
  }
}
...
class PlatformIdentifierBridge {
  ...
  PlatformIdentifierBridge() {
    ...
    _identifyFromFile = _lib.lookupFunction<
        ...
        bool Function(ffi.Pointer<Utf8>, ffi.Pointer<GameIdentityNative>)
    >('identify_from_file');
  ...
  GameIdentity? identifyFile(String filePath) {
    ...
    try {
      ...
      return GameIdentity(
        ...
        titleId: native.titleId.toDartString(),
        gameTitle: native.gameTitle.toDartString(),
...
final class GameIdentityNative extends ffi.Struct {
  ...
  external ffi.Pointer<Utf8> titleId;
  external ffi.Pointer<Utf8> gameTitle;
...
typedef IdentifyFromFile = bool Function(ffi.Pointer<Utf8>, ffi.Pointer<GameIdentityNative>);
