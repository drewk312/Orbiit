...
class Titles extends Table {
  ...
  TextColumn get healthStatus => text().withDefault(const Constant('unknown'))();
...
class Issues extends Table {
  ...
  IntColumn get estimatedImpactScore => integer().withDefault(const Constant(0))();
  IntColumn get estimatedSpaceSavings => integer().withDefault(const Constant(0))();
...
class HealthSnapshots extends Table {
  ...
  IntColumn get missingMetadataCount => integer().withDefault(const Constant(0))();
  IntColumn get totalSizeBytes => integer().withDefault(const Constant(0))();
  IntColumn get potentialSavingsBytes => integer().withDefault(const Constant(0))();
}
