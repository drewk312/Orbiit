...
class GameBrewService {
  ...
  static const String _hacksListUrl = 'https://www.gamebrew.org/wiki/List_of_Wii_rom_hacks';
  static const String _translationsListUrl = 'https://www.gamebrew.org/wiki/List_of_Wii_translations';
  ...
  Future<List<GameResult>> fetchHomebrew() async {
    ...
    final translations = await _scrapeWikiPage(_translationsListUrl, 'Translation');
  ...
  Future<List<GameResult>> _scrapeWikiPage(String url, String defaultRegion) async {
    try {
        ...
        for (final row in rows) {
          ...
          if (cells.isNotEmpty) {
            ...
            if (link != null) {
              ...
              if (title.isNotEmpty && href != null && !href.contains('redlink=1') && !href.contains('#')) {
