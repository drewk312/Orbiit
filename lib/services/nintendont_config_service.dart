...
/// Nintendont controller configuration service
///
/// Generates .ini config files for USB controllers to use with Nintendont.
/// Config files are stored at SD:/controllers/VID_PID.ini
class NintendontConfigService {
  /// GameCube button enumeration
...
class ButtonMapping {
  ...
  ButtonMapping({required this.byte, required this.bitmask});
...
class AxisMapping {
  ...
  AxisMapping({required this.axisIndex, this.invert = false});
