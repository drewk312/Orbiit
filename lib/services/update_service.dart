...
class UpdateService {
  ...
  Future<UpdateRelease?> checkForUpdates() async {
    try {
      final uri = Uri.https('api.github.com', '/repos/$_repoOwner/$_repoName/releases/latest');
  ...
  Future<void> downloadAndInstall(UpdateRelease release, Function(double) onProgress) async {
