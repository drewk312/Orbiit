...
class ScannerService {
  ...
  Future<List<ScannedGame>> scanDirectory(String directoryPath) async {
      ...
      if (games.isEmpty) {
        ...
        if (await dir.exists()) {
          try {
            ...
            debugPrint('[Scanner] Error listing directory in fallback: $e');
          }
        }
      }
    ...
    try {
      ...
      debugPrint('[Scanner] Error listing directory: $e');
    }
  ...
  Future<ScannedGame?> _parseGameFile(File file) async {
    try {
      ...
      try {
        ...
        debugPrint('[Scanner] Could not read header: ${file.path} - $e');
      }
      ...
      debugPrint('[Scanner] Error parsing file: ${file.path} - $e');
      return null;
    }
  }
  ...
  Future<bool> deleteGame(ScannedGame game) async {
    try {
      ...
      debugPrint('[Scanner] Error deleting file: $e');
      return false;
    }
  }
}
