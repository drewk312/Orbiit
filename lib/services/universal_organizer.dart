...
class UniversalOrganizer {
  ...
  static Map<String, String> getDestination(String rootDrive, String platform, String rawFilename) {
    ...
    if (platform == 'PS1') {
      ...
      return {
        'fullPath': p.join(rootDrive, subFolder, rawFilename), // Keep original filename for compatibility (.cue sheets)
  ...
  static String _cleanTitle(String filename) {
    ...
    title = title.replaceAll(RegExp(r'\((USA|Europe|Japan|En,Fr,Es|World)\)', caseSensitive: false), '');
