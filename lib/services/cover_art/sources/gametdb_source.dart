...
class GameTDBSource implements CoverArtSource {
  ...
  @override
  Future<CoverArtResult?> searchByTitle(String title, GamePlatform platform) async {
  ...
  @override
  Future<CoverArtResult?> getByGameId(String gameId, GamePlatform platform) async {
    ...
    try {
      ...
      for (final region in regions) {
        ...
        if (response.statusCode == 200) {
          ...
          alternates['cover3D'] = '$baseUrl/$platformCode/cover3D/$region/$gameId.png';
          alternates['disc'] = '$baseUrl/$platformCode/disc/$region/$gameId.png';
          alternates['coverfull'] = '$baseUrl/$platformCode/coverfull/$region/$gameId.png';
          
          return CoverArtResult(
            sourceUrl: coverUrl,
            sourceName: sourceName,
            quality: CoverArtQuality.high, // GameTDB typically has high-quality covers
            gameId: gameId,
