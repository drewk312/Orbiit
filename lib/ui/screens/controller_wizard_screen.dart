...
class _ControllerWizardScreenState extends State<ControllerWizardScreen> {
  ...
  final List<String> _mappingSequence = [
    'A', 'B', 'X', 'Y', 'Z', 'L', 'R', 'Start',
    'Up', 'Down', 'Left', 'Right', // Stick / DPad depending on mode, usually Stick first
  ...
  void _showResultDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text("Configuration Generated", style: TextStyle(color: Colors.white)),
        content: SingleChildScrollView(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisSize: MainAxisSize.min,
            children: [
               const Text("Save this as .ini file in /controllers folder:", style: TextStyle(color: Colors.white70)),
             ...
             if (_controllerName != null)
                Padding(
                  ...
                  child: Chip(
                    ...
                    label: Text(_controllerName!, style: const TextStyle(color: Colors.white)),
