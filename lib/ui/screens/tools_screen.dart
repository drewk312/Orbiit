...
class _GameBackupManagerDialogState extends State<GameBackupManagerDialog> {
                      ...
                      children: [
                        Text('Game Backup Manager',
                            style: TextStyle(
                                ...
                                fontSize: 20,
                                fontWeight: FontWeight.bold)),
                        Text('Copy & organize Wii game backups',
                            style:
                                TextStyle(color: Colors.white70, fontSize: 13)),
                      ],
                    ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'This tool copies Wii/GameCube game files to the correct folder structure for USB loaders. '
                        'Your USB drive MUST be formatted as FAT32 (not exFAT or NTFS).',
                        style: TextStyle(
                            color: Colors.white.withValues(alpha: 0.8),
                            fontSize: 13),
                      ),
                    ...
                    // Source selector
                    _buildPathSelector(
                        'Source (Game File)', _sourcePath, Icons.folder_open,
                        (path) {
                    ...
                    _buildPathSelector(
                        'Destination (USB/SD)', _destPath, Icons.usb, (path) {
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Copy Game to USB'),
                        style: ElevatedButton.styleFrom(
                    ...
                    Wrap(
                      spacing: 8,
                      children: ['.iso', '.wbfs', '.rvz', '.nkit', '.gcm']
                          .map((ext) => Chip(
                                label: Text(ext,
                                    style: const TextStyle(
  ...
  Future<void> _copyGame() async {
    // Placeholder - actual implementation would copy files
    setState(() {
      _isProcessing = true;
      _progress = 0.0;
    });
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Game copied successfully!'),
            backgroundColor: Colors.green),
      );
    }
  }
