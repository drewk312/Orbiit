  ...
  group('LibraryStateService', () {
    ...
    test('Deduplicates games by ID', () {
      ...
      final game1 = ScannedGame(
        path: '/a', fileName: 'a', title: 'Game A', 
        platform: 'Wii', sizeBytes: 100, extension: '.iso',
        gameId: 'RMCE01'
      );
      
      final game2 = ScannedGame(
        path: '/b', fileName: 'b', title: 'Game A Duplicate', 
        platform: 'Wii', sizeBytes: 100, extension: '.iso',
        gameId: 'RMCE01' // Same ID
      );
      
      final game3 = ScannedGame(
        path: '/c', fileName: 'c', title: 'Game B', 
        platform: 'Wii', sizeBytes: 100, extension: '.iso',
        gameId: 'GALE01'
      );
    ...
    test('Handles games without IDs', () {
      ...
      final noId1 = ScannedGame(
        path: '/a', fileName: 'a', title: 'No ID 1', 
        platform: 'Wii', sizeBytes: 100, extension: '.iso',
        gameId: null
      );
      
      final noId2 = ScannedGame(
        path: '/b', fileName: 'b', title: 'No ID 2', 
        platform: 'Wii', sizeBytes: 100, extension: '.iso',
        gameId: ''
      );
    ...
    test('Validates Health Calculation', () {
      ...
      final g1 = ScannedGame(path: '', fileName: '', title: '', platform: '', sizeBytes: 0, extension: '', health: 100);
      final g2 = ScannedGame(path: '', fileName: '', title: '', platform: '', sizeBytes: 0, extension: '', health: 50);
